  ...
  return async (dispatch) => {
    ...
    const getData = async () => {
      const res = await fetch(
        "https://sense-clothing.herokuapp.com/shop/products"
      );
...
export const getCatProducts = (cat) => {
  ...
  return async (dispatch) => {
    ...
    const getData = async () => {
      const res = await fetch(
        "https://sense-clothing.herokuapp.com/shop/cat-products?cat=" + cat
      );
...
export const getProductDetail = (id) => {
  ...
  return async (dispatch) => {
    ...
    const getData = async () => {
      const res = await fetch(
        "https://sense-clothing.herokuapp.com/shop/product-detail/" + id
      );
