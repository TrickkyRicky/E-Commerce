  ...
  return async (dispatch) => {
    const putData = async () => {
      const res = await fetch(
        "https://sense-clothing.herokuapp.com/auth/signup",
        {
          method: "PUT",
          headers: {
...
export const postLogin = (email, pass) => {
  ...
  return async (dispatch) => {
    const postData = async () => {
      const res = await fetch(
        "https://sense-clothing.herokuapp.com/auth/login",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
...
export const postReset = (email) => {
  return async (dispatch) => {
    const postData = async () => {
      const res = await fetch(
        "https://sense-clothing.herokuapp.com/auth/reset",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
...
export const getNewPass = (token) => {
  return async (dispatch) => {
    const getData = async () => {
      const res = await fetch(
        "https://sense-clothing.herokuapp.com/auth/newpass/" + token
      );
      if (res.status === 401) {
...
export const puthNewPass = (pass, token, id) => {
  return async (dispatch) => {
    const putData = async () => {
      const res = await fetch(
        "https://sense-clothing.herokuapp.com/auth/newpass",
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
